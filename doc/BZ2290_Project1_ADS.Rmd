...
beeswarm(nword~Ordered, 
         ...
         main="Inauguartion speeches")
```
We see that from the second to the fourth speeches, both the sentences' length and the number of sentences have decreased from one speech to another.

In addition to this pattern, I have also discovered that:
```{r, echo=FALSE}
...
For now, we have observed that emotion "fear" always comes fourth in our barplot of emotions for the "peace" group, the emotion of presidential speeches during war time is surprisingly positive, and two presidents whose speeches were given thorought out wars have opposite change on emotion "fear".In order to shed lights into these patterns, I decided to utilize some other analysis to derive more insights.
...
I first tries two clusters to analysis the war group:
